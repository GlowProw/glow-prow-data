export const CosmeticEffects = ["emissive", "combatReactive", "killReactive", "bossKillReactive", "animated"] as const;
...
export const PlayerOutfitTypes = ["headwear", "faceAccessory", "torso", "neck", "forearm", "hand", "waist", "bottom", "footwear", "bodyCosmetics", "emote"] as const;

export type PlayerOutfitType = (typeof PlayerOutfitTypes)[number];

export const PlayerAppearanceTypes = ["hair", "facialHair", "eyeColor"] as const;
